...
if ispc
    mex -v lbfgsb_wrapper.c -largeArrayDims  -UDEBUG ...
        Lbfgsb.3.0-src/lbfgsb.f Lbfgsb.3.0-src/linpack.f Lbfgsb.3.0-src/timer.f ...
...
if ~ispc && strfind(computer, '64' )
    ...
    mex -v lbfgsb_wrapper.c -largeArrayDims  -UDEBUG ...
        Lbfgsb.3.0-src/lbfgsb32.f Lbfgsb.3.0-src/linpack32.f ... % using new files
        Lbfgsb.3.0-src/timer.f ...
        -lm -lmwblascompat32 ...
...
semilogy( info.err(:,3)-f,'o-' ); xlabel('iteration');
ylabel('relative error in iterate function');
